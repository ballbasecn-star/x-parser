...
X_PARSER_IMAGE="${X_PARSER_IMAGE:-ballbase/x-parser}"
DEPLOY_HOST="${DEPLOY_HOST:-}"
DEPLOY_USER="${DEPLOY_USER:-root}"
DEPLOY_PASSWORD="${DEPLOY_PASSWORD:-}"
DEPLOY_PORT="${DEPLOY_PORT:-22}"
DEPLOY_BASE_DIR="${DEPLOY_BASE_DIR:-/root/apps/parsers/x-parser}"
X_PARSER_HOST_PORT="${X_PARSER_HOST_PORT:-5000}"
SERVER_HEALTHCHECK_URL="${SERVER_HEALTHCHECK_URL:-http://127.0.0.1:${X_PARSER_HOST_PORT}/api/v1/health}"
SERVER_CAPABILITIES_URL="${SERVER_CAPABILITIES_URL:-http://127.0.0.1:${X_PARSER_HOST_PORT}/api/v1/capabilities}"
